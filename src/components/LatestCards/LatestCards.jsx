...
function LatestCards({
  ...
  return (
    <div className="flex flex-col md:flex-row md:justify-between md:gap-10 md:items-center text-left text-cfew-primary-900 mb-16 md:mb-30">
      {/* <div className='w-full'>
        <img src={imageSrc} className='w-full h-auto md:h-75 lg:h-auto object-cover' alt={title}/>
      </div> */}
      <div className="w-full h-[300px] md:w-[500px] lg:w-[700px] aspect-[4/3] md:aspect-[16/9] lg:aspect-[3/2]">
        <img
          src={imageSrc}
          alt={title}
