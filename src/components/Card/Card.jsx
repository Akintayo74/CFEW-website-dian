...
function Card() {
  return (
    <Container>
      <div className='bg-cfew-transparent p-5 md:w-120 lg:w-160 2xl:w-200'>
        <h4 className='font-bold mb-5 text-cfew-interface text-4xl lg:font-black lg:text-6xl'>Securing the Earth Through Community Empowerment</h4>
