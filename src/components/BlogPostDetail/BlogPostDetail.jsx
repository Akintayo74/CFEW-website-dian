    ...
    <Layout>
      <DataStateWrapper
        ...
        config={{
          ...
          errorMessage: "Failed to load the blog post. Please try again later.",
          showErrorDetails: true,
          errorBackLink: { to: "/resources", label: "Back to Resources" },
          emptyMessage: "The blog post you're looking for doesn't exist or has been removed.",
