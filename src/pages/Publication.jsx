  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const formData = {
        ...
        excerpt,
        link,
        featuredImage: "https://example.com/images/publication-featured.jpg" // In a real app, you'd upload this to a storage service first
      };
      ...
      setSubmitStatus({
        success: false,
        message: error.response?.data?.message || 'Failed to submit publication. Please try again.'
      });
    } finally {
    ...
    <div className="w-full h-full flex">
      ...
      <div className="flex-1 p-6 pr-4">
        ...
        <form onSubmit={handleSubmit} className="max-w-[790px]">
          {/* Title */}
          <label className="block text-[14px] text-[#1B2816] font-normal mb-2">Title</label>
          <input
            type="text"
            value={title}
